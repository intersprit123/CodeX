...
export default function TradingChart({symbol='TCS'}:Props){
  ...
  useEffect(()=>{if(!replay)return;const id=window.setInterval(()=>setReplayIndex(i=>{const next=(i??0)+1;if(next>=data.length-1){setReplay(false);return null}return next}),80);return()=>window.clearInterval(id)},[replay])
